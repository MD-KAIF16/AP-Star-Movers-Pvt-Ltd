...
import { 
  ...
  Clock, PackageCheck, Zap, Users, Shield, TrendingUp, 
  Quote, Calendar, Warehouse, Mail, MessageCircle, Map, 
  Briefcase, Heart, Factory, Navigation, Route
} from "lucide-react";
...
Thank You.`;
    ...
    try {
      ...
      alert("Unable to open WhatsApp. Please call us directly at +91 7080815294.");
    }
  };
