...
import { Truck, MessageCircle, ArrowUp, MapPin, Mail, Phone, ArrowRight } from "lucide-react";
              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-3 text-zinc-400">
                    ...
                    <span className="font-bold">+91 8048615828</span>
                  </div>
                  <div className="flex items-center gap-3 text-zinc-400">
          ...
          <div className="container relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16 px-6">
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed max-w-sm">
                Moving India's Businesses with Trust, Speed and Excellence. An international standard logistics partner based in Prayagraj.
              </p>
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="space-y-4 text-sm font-medium text-zinc-400">
                <li><a href="/#about" onClick={(e) => handleNavClick(e, "/#about", "about")} className="hover:text-lime-400 transition-colors inline-flex items-center gap-2 group cursor-pointer"><ArrowRight className="h-3 w-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" /> About Us</a></li>
                <li><a href="/#services" onClick={(e) => handleNavClick(e, "/#services", "services")} className="hover:text-lime-400 transition-colors inline-flex items-center gap-2 group cursor-pointer"><ArrowRight className="h-3 w-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" /> Services</a></li>
                <li><a href="/#fleet" onClick={(e) => handleNavClick(e, "/#fleet", "fleet")} className="hover:text-lime-400 transition-colors inline-flex items-center gap-2 group cursor-pointer"><ArrowRight className="h-3 w-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" /> Fleet</a></li>
                <li><a href="/#why-us" onClick={(e) => handleNavClick(e, "/#why-us", "why-us")} className="hover:text-lime-400 transition-colors inline-flex items-center gap-2 group cursor-pointer"><ArrowRight className="h-3 w-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" /> Why Us</a></li>
