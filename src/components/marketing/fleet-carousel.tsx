    ...
    <div className="relative w-full max-w-[100vw] overflow-hidden group">
          ...
          {vehicles.map((v, i) => (
            ...
            >
              ...
              <motion.div 
                ...
                className="relative cursor-pointer bg-zinc-950 border border-white/10 rounded-[32px] md:rounded-[40px] overflow-hidden h-full flex flex-col hover:border-lime-500/50 hover:shadow-[0_20px_60px_-15px_rgba(163,230,21,0.2)] transition-all duration-500"
              >
                {/* Glowing border effect on hover via pseudo-elements */}
                <div className="absolute inset-0 bg-gradient-to-br from-lime-500/0 via-transparent to-lime-500/0 opacity-0 group-hover:opacity-10 transition-opacity duration-700 pointer-events-none" />
                ...
                <div className="p-6 md:p-8 flex flex-col flex-grow relative z-20 bg-zinc-950">
                  ...
                  <ul className="space-y-2 mb-8 border-t border-white/5 pt-6">
                    <li className="flex items-center gap-3 text-xs md:text-sm text-zinc-300 font-medium">
                      <Zap className="w-4 h-4 text-lime-400" /> GPS Tracked
                    </li>
                    <li className="flex items-center gap-3 text-xs md:text-sm text-zinc-300 font-medium">
                      <ShieldCheck className="w-4 h-4 text-lime-400" /> Insured Transit
                    </li>
                  </ul>
                  ...
                  <button 
                    ...
                    className="group/btn relative flex items-center justify-center w-full py-4 md:py-5 rounded-full bg-white/5 border border-white/10 text-white text-sm md:text-base font-bold overflow-hidden transition-all duration-300 hover:border-lime-400"
                  >
                    <div className="absolute inset-0 bg-lime-400 translate-y-full group-hover/btn:translate-y-0 transition-transform duration-300 ease-out" />
      ...
      <div className="hidden md:flex items-center justify-center gap-4 mt-4 relative z-20 pointer-events-none">
        <button
          ...
          className="pointer-events-auto h-14 w-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-lime-400 hover:text-black hover:border-lime-400 disabled:opacity-30 disabled:hover:bg-white/5 disabled:hover:text-white disabled:hover:border-white/10 transition-all duration-300 backdrop-blur-md"
        >
